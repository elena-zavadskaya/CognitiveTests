...
class Result(models.Model):
    ...
    time_spent = models.CharField(max_length=20, verbose_name="Время выполнения теста")
    total_questions = models.PositiveIntegerField(verbose_name="Количество вопросов")
